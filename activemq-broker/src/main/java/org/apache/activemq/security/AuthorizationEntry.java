...
public class AuthorizationEntry extends DestinationMapEntry {
    ...
    public boolean equals(Object o) {
        ...
        if (browseACLs != null ? !browseACLs.equals(that.browseACLs) : that.browseACLs != null) return false;
        if (browseRoles != null ? !browseRoles.equals(that.browseRoles) : that.browseRoles != null) return false;
